...
map <-
  ...
  addPolygons(data = demographics, group = "Show API Population<hr padding:0px;margin:0px;>", fillColor = ~demo_pal(pct_api_clean), color = gray, weight = 1, fillOpacity = .8, popup = ~popup) %>%
  
  # legends
  
  addLegend(position = "bottomright", pal = demo_pal, values = demographics$pct_api_clean, opacity = .8, title = "API Population", group = "Show API Population<hr padding:0px;margin:0px;>")
